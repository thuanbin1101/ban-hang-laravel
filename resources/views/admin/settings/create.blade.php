...
@section('content')
    ...
    <div class="row">
        <form class="col-md-12" method="POST" action="{{route('settings.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="inputEmail4" class="col-form-label">Config Key</label>
                    <input name="config_key" type="text" class="form-control" id="inputEmail4" placeholder="">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    @if(request()->get('type') === "Text")
                        <input name="config_value" type="text" class="form-control" id="inputEmail4" placeholder="">
                    @else
