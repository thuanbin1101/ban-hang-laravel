...
@section('content')
    ...
    @endif
    <div class="row">
        <form class="col-md-12" method="POST" action="{{route('categories.update',$category->id)}}"
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <input name="name" value="{{$category->name}}" type="text" class="form-control" id="inputEmail4"
                           placeholder="">
                </div>
            </div>
